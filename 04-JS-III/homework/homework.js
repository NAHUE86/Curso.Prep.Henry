...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  var resultadoPromediosParcial = 0
  var largoArray = resultadosTest.length
  
  for (let i = 0; i < resultadosTest.length; i++) {
   resultadoPromediosParcial = resultadoPromediosParcial + resultadosTest[i] 
   }
  console.log(resultadoPromediosParcial)
  return resultadoPromediosParcial / largoArray; 
  }
